...
implements Runnable {
    ...
    public FirstMMRConnectionThread(String string, int n, long l, ImmutableProxyInterface immutableProxyInterface) {
        this.m_name = string;
        this.m_port = n;
        this.m_timeout = l;
    ...
    public TinyTLS getConnection() throws IOException {
        this.m_thread = new Thread((Runnable)this, "FirstMMRConnectionThread");
