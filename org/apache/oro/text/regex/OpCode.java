...
final class OpCode {
    ...
    static final int _getNextOffset(char[] arrc, int n) {
        return arrc[n + 1];
    }

    static final char _getArg1(char[] arrc, int n) {
        return arrc[n + 2];
    }

    static final char _getArg2(char[] arrc, int n) {
        return arrc[n + 3];
    }
    ...
    static final boolean _isInArray(char c, char[] arrc, int n) {
        while (n < arrc.length) {
    ...
    static final int _getNext(char[] arrc, int n) {
        if (arrc == null) {
            return -1;
        }
        int n2 = OpCode._getNextOffset(arrc, n);
        if (n2 == 0) {
            return -1;
        }
        if (arrc[n] == '\r') {
