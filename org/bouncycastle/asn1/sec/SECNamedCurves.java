...
public class SECNamedCurves {
    static X9ECParametersHolder secp112r1 = new X9ECParametersHolder(){
        ...
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(eCCurve, x9ECPoint, bigInteger4, bigInteger5, arrby);
        }
    };
    ...
    static X9ECParametersHolder sect113r1 = new X9ECParametersHolder(){
        ...
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(eCCurve, x9ECPoint, bigInteger3, bigInteger4, arrby);
        }
    };
    ...
    static void defineCurve(String string, ASN1ObjectIdentifier aSN1ObjectIdentifier, X9ECParametersHolder x9ECParametersHolder) {
        objIds.put(string.toLowerCase(), aSN1ObjectIdentifier);
